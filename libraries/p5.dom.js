...
(function(root, factory) {
   ...
   * function setShade1() {
   *   setMidShade();
   *   console.debug('You are choosing shade 1 to be : ', this.value());
   * }
   * function setShade2() {
   *   setMidShade();
   *   console.debug('You are choosing shade 2 to be : ', this.value());
   * }
   * </code>
   * </div>
   */
   ...
   *   console.debug('you are typing: ', this.value());
   * }
   * </code></div>
   */
